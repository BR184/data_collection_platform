  ...
  static Map<String, DatabaseBrowserTableDefinition> definitions() {
    return Map.of(
        ...
        definition(
            ...
            column("project_path", "GitLab 项目路径"),
            ...
            column("deleted_lines", "删除代码行数"),
            column("metric_source_updated_at", "源指标更新时间"),
            column("enrichment_status", "补齐状态"),
            column("enrichment_version", "补齐版本"),
            column("enrichment_attempts", "补齐尝试次数"),
            column("enrichment_error", "补齐错误"),
            column("enrichment_next_attempt_at", "下次补齐时间"),
            column("enrichment_attempted_at", "最近补齐尝试时间"),
            column("enrichment_succeeded_at", "补齐成功时间"),
