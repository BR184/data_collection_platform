  ...
  private static final String MERGE_REQUEST_SOURCE_SQL = """
      ...
      imported_metrics as (
        select m.project_id,
               ...
               m.deleted_lines,
               m.code_specification_count,
               m.code_logic_specification_count,
               m.performance_specification_count,
               m.design_specification_count,
               m.other_specification_count,
               m.review_speed_loc_per_hour,
               m.review_speed_kloc_per_hour,
               m.review_defect_density_per_kloc,
               m.review_efficiency_per_hour,
               m.commit_count,
               m.commit_rate,
               nullif(btrim(m.function_name), '') as function_name,
               m.clang_added_line_count,
      ...
      select
        ...
        imported_metrics.deleted_lines,
        imported_metrics.code_specification_count,
        imported_metrics.code_logic_specification_count,
        imported_metrics.performance_specification_count,
        imported_metrics.design_specification_count,
        imported_metrics.other_specification_count,
        imported_metrics.review_speed_loc_per_hour,
        imported_metrics.review_speed_kloc_per_hour,
        imported_metrics.review_defect_density_per_kloc,
        imported_metrics.review_efficiency_per_hour,
        imported_metrics.commit_count,
        imported_metrics.commit_rate,
        imported_metrics.function_name,
        imported_metrics.clang_added_line_count,
