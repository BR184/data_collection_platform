...
final class IntegrationTestFactRules {
  ...
  static ValidationResult validateRecord(
    ...
    if (!negativeFields.isEmpty()) {
      return new ValidationResult(false, "PARTIAL", String.join("、", negativeFields) + "不能为负数");
    }
  ...
  private static String normalizeFunctionLabel(String value) {
  ...
  private static void addNegativeField(
      List<String> negativeFields, String fieldName, Integer value) {
