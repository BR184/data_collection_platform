...
public class LabelDimensionCatalogService {
  ...
  private static Map<String, LabelDimensionDefinition> createDimensions() {
    ...
    put(dimensions, "project", "项目", "事实层项目名称", LabelValueKind.STRING_LITERAL);
  ...
  private static Map<String, List<LabelGroupCompatiblePageResponse>> createCompatiblePages() {
    ...
    add(pages, "review_owner", "review-data-home", "评审数据管理", "reviewOwner", "评审负责人", true);
    add(pages, "review_expert", "review-data-home", "评审数据管理", "reviewExpert", "评审专家", true);
