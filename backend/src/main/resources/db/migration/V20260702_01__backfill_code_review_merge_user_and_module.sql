...
begin
  if to_regclass('public.merge_request_fact') is null
      ...
      or to_regclass('public.ods_gitlab_users') is null
      or to_regclass('public.ods_gitlab_label_links') is null
      or to_regclass('public.ods_gitlab_labels') is null then
    return;
  end if;
