...
const MANUAL_HEADER_LINES: Record<string, TableHeaderLines> = {
  ...
  '评审速率(页/小时)': ['评审速率', '(页/小时)'],
  '评审速率（页/小时）': ['评审速率', '(页/小时)'],
  '独立评审工作量合计(小时)': ['独立评审', '工作量合计(小时)'],
  '会议评审工作量合计(小时)': ['会议评审', '工作量合计(小时)'],
  '会议评审工作量(小时)': ['会议评审', '工作量(小时)'],
  '会议评审工作量(小时）': ['会议评审', '工作量(小时)'],
  '会议评审工作量（小时）': ['会议评审', '工作量(小时)'],
  '清单评审工作量合计(小时)': ['清单评审', '工作量合计(小时)'],
  '有效独立评审问题数合计(个)': ['有效独立评审', '问题数合计(个)'],
  '有效的独立评审问题数合计(个)': ['有效独立评审', '问题数合计(个)'],
  '有效会议评审问题数合计(个)': ['有效会议评审', '问题数合计(个)'],
  '有效的会议评审问题数合计(个)': ['有效会议评审', '问题数合计(个)'],
  '合并请求编号': ['合并请求', '编号'],
  '合并请求内容': ['合并请求', '内容'],
  '合并目标分支': ['合并目标', '分支'],
  '议题编号': ['议题', '编号'],
  ...
  '复测未通过缺陷数（个）': ['复测未通过', '缺陷数(个)'],
  '一级缺陷已修复数量': ['一级缺陷', '已修复数量'],
  '二级缺陷已修复数量': ['二级缺陷', '已修复数量'],
  '三级缺陷修复数量': ['三级缺陷', '修复数量'],
  'P1级别缺陷数量': ['P1级别', '缺陷数量'],
  'P2级别缺陷数量': ['P2级别', '缺陷数量'],
  'P3级别缺陷数量': ['P3级别', '缺陷数量'],
...
function isGoodMetricSubject(subject: string, tail: string) {
  ...
  if (['比例', '效率', '速率', '密度', '工作量', '工作量合计', '问题数合计', '行数', '代码行数'].includes(tail)) {
    return visualTextUnits(subject) >= 4;
  }
  return (
    /缺陷$/.test(subject)
