...
export const modules: ShellModule[] = [
  ...
  },
  {
    ...
    pages: [
      ...
      {
        key: 'dropdown-option-settings',
        label: '下拉框选项设置',
        icon: Filter,
        description: '配置各下拉框显示哪些选项：黑白名单过滤与手动添加，支持多字段共用与拆分。',
        path: '/system-settings/dropdown-option-settings',
        requiresLogin: true,
        hiddenForApproval: true,
        permission: 'system.dropdown_option.view',
      },
      {
        key: 'backup-settings',
        label: '备份管理',
        icon: Box,
        description: '配置每日定时数据库备份、远程备份服务器，执行备份并查看状态与历史。',
