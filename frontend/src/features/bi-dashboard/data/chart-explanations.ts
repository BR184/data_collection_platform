...
export const BI_CHART_EXPLANATIONS = {
  ...
  // === 阶段 2：编码阶段 ===
  codingReviewQuality: '统计各模块人工代码走查缺陷密度与走查速率。达标标准：代码走查缺陷密度介于[2.0~10.0]个/KLOC；走查速率无达标要求。',
  ...
  systemTestModuleRepair: '统计各模块整体修复率、一级修复率、P1/P2修复率。达标标准：整体修复率 >= 95.00%。修复率 0% 表示该模块已发现缺陷但尚未修复，属最高风险，异常优先视图下排在最前；仅无可计算数值时置于列表末尾。',
